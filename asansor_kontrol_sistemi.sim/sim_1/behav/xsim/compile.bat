...
REM
REM Generated by Vivado on Tue Dec 16 19:32:54 +0300 2025
...
echo "xvhdl --incr --relax -prj tb_asansor_fsm_vhdl.prj"
call xvhdl  --incr --relax -prj tb_asansor_fsm_vhdl.prj -log xvhdl.log
